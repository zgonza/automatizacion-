...
formatter.scenario({
  "name": "User Registrer",
  "description": "Since I want to register on the page",
  "keyword": "Scenario"
});
formatter.step({
  "name": "I fill in all the mandatory fields of the form",
  "keyword": "When "
});
formatter.match({
  "location": "CompraOnLineStepdefinitions.iFillInAllTheMandatoryFieldsOfTheForm()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "I must be registered in the system",
  "keyword": "Then "
});
formatter.match({
  "location": "CompraOnLineStepdefinitions.iMustBeRegisteredInTheSystem()"
});
formatter.result({
  "status": "passed"
});
